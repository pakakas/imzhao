...
const mzHeader = 'MZrulesⓖgridʀrow§columns¦delimiter→is※gridreference★titleɛescape';
const mzHeaderMdkv = "MZrules:ⓖ=grid:ʀ=row:§=columns:¦=delimiter:→=is:※=gridreference:★=title:ɛ=escape";
