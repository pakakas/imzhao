...
| **mz-header** | <pre>Agent Data Notation:<br>ⓖ is grid marker<br>ʀ is row marker<br>§ is column marker<br>¦ is delimiter<br>→ is key-value relation<br>★ is title marker<br>Agent Intermediate Representation:<br>τ is type annotation<br>ⓘ is invoke to</pre> | <pre>ⓘadd_import src/App.tsx react useState</pre> |
| **mz** | <pre>Choose your tool and respond with ⓘtool arg1 arg2<br>★Registryⓖ§cmd¦args¦returnsʀadd_import¦file τstr module τstr imports τstr¦τgridʀapply_code_action¦file τstr line τnum action τstr¦τgridʀsearch_docs¦qu</pre> | <pre>ⓘadd_import src/App.tsx react useState</pre> |
