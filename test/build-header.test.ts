...
assertIncludes(h1, "→ is row marker", "has →");
assertIncludes(h1, "§ is column marker", "has §");
...
assertIncludes(h2, "→ is row marker", "has →");
assertIncludes(h2, "§ is column marker", "has §");
...
assertIncludes(h4, "· is interned string", "has ·");
assertIncludes(h4, "¤ is string reference", "has ¤");
assertIncludes(h4, "░ is grid marker", "has ░");
assertIncludes(h4, "→ is row marker", "has →");
...
assertIncludes(h8, "§ is column marker", "has §");
assertIncludes(h8, "¦ is delimiter", "has ¦");
assertIncludes(h8, "≡ is key-value relation", "has ≡");
assertIncludes(h8, "※ is grid reference", "has ※");
...
assertNotIncludes(h9, "→ is row marker", "no →");
assertNotIncludes(h9, "≡ is key-value relation", "no ≡");
...
assertIncludes(h10, "→ is row marker", "has →");
assertIncludes(h10, "§ is column marker", "has §");
assertIncludes(h10, "¦ is delimiter", "has ¦");
assertIncludes(h10, "≡ is key-value relation", "has ≡");
assertIncludes(h10, "† is title marker", "has †");
assertIncludes(h10, "τ is type annotation", "has τ");
assertNotIncludes(h10, "※ is grid reference", "no ※");
assertNotIncludes(h10, "⇒ is pipe", "no ⇒");
...
assertIncludes(h11, "§ is column marker", "has §");
...
assertIncludes(h12, "※ is grid reference", "has ※");
assertIncludes(h12, "τ is type annotation", "has τ");
assertIncludes(h12, "† is title marker", "has †");
